...
Powered by Google Gemini API — 100% FREE (1,500 reviews/day, no credit card)

Setup:
  1. Get free API key from https://aistudio.google.com/apikey  (takes 2 minutes)
  2. Paste key in .env file or in the sidebar when the app opens
